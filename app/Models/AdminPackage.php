 ...
 * different admins with two different location/hotel scopes (e.g. the
 * same `Manager · Kampot` package assigned to two different admins
 * with two different `location_ids`, if a developer wanted that), and
 * one
